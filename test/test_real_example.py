...
def test_news_article():
    ...
    expected = """<div itemprop="articleBody">
        ...
        <br>
        <h3 style="color: black; font-weight: bold; font-size: 18px;">Lattner und Casebolt neue Tesla-Entwickler</h3>
        <p style="margin-top: 10px;"><a class="anchorman" data-entity="person" form="Chris Lattner" href="/chris-lattner" score="7.033">Chris Lattner</a> arbeitete seit mehr als einem Jahrzehnt für <a class="anchorman" data-entity="org" form="Apple" href="/apple" score="42.001">Apple</a>. In einer Nachricht sagte Lattner zu <a class="anchorman" data-entity="org" form="Apple" href="/apple" score="42.001">Apple</a>-Entwicklern, dass er "<a class="anchorman" data-entity="org" form="Apple" href="/apple" score="42.001">Apple</a> später in diesem Monat verlassen werde", um eine berufliche Chance in einem anderen Bereich zu ergreifen. Lattner selbst nannte Tesla nicht als neuen Arbeitgeber.&nbsp;</p><p style="margin-top: 1em;">Dies übernahm später <a class="anchorman" data-entity="org" form="Tesla" href="/tesla" score="42.001">Tesla</a>, als es verkündete, man habe Lattner als Vizepräsidenten für das Projekt <a href="http://www.automobilwoche.de/apps/pbcs.dll/search?q=autopilot+tesla&amp;BuildNavigators=1" target="_blank">"Autopilot"</a>-Software verpflichtet.</p><p style="margin-top: 1em;">Nach Informationen des <a href="https://9to5mac.com/2017/01/11/matt-casebolt-touchbar-macbook/" target="_blank">Blogs <em>9to5Mac</em></a> arbeitet der ehemals für die Mac-Entwicklung zuständige Senior Director of Design, Matt Casebolt<em> <br></em>schon seit Dezember 2016 als Entwicklungschef für "Schließelemente und Mechanismen". Zuletzt hat Casebold die Entwicklung des neuen <a class="anchorman" data-entity="product" form="MacBook Pro" href="/macBook-pro" score="14.001">MacBook Pro</a> mit Touch Bar geleitet und war zuvor am 2013 neu eingeführten 
         beteiligt.</p>
        <br>
        <h3 style="color: black; font-weight: bold; font-size: 18px;">Apple und die Zukunftsforscher</h3>
        <div class="header_category box_border_bottom_orange box_border_top_lightgray box_border_left_lightgray box_border_right_lightgray" style="padding-top: 2px;">
