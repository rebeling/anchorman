...
def test_unit_slices_utils():
    ...
    assert regex == ur'\bdog\b|\bAngela M.\b|\büberätzend\b'

    # # case_insensitive
    # regex2 = token_regexes([element1, element2, element3], False)
    # assert regex2 == ur'\bdog\b|\bDog\b|\bDOG\b|\bAngela M.\b|\bANGELA M.\b|\bangela m.\b|\büBeräTzend\b|\büBERäTZEND\b|\büberätzend\b'
